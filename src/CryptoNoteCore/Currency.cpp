...
bool Currency::generateGenesisBlock() {
  ...
  std::string genesisCoinbaseTxHex = "010a01ff0001e09e8aae8f85d7c70202401026f0b38107e8aeb18f2d3be215eb37e1b6b1549bd61447d62f1bf4db1ca021010543978577003cf8ba84fc84149c3e51005e9c68756ee90f63e8ad4f91b69124";
...
bool Currency::getBlockReward(uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
  ...
  // FMC REWARD CHANGES
  uint64_t baseReward;
  uint64_t factorCut = 44500000; // 0.445 FMC
  uint64_t coinCut_v1 = 264000000000000; // 2.64M FMC
  uint64_t coinCut_v2 = 292000000000000; // 2.92M FMC
 ...
 //infinite minimal block rewards after block reward falls under m_finalSubsidy per minute
  ...
  if (baseReward < subsidyTarget) {
	  baseReward = subsidyTarget; // Subsidy 0.20 FMC
  }
